...
use super::{
    ...
    GapRepairProjectionId, InReplyToDetails, MediaUploadProgress, Profile, TimelineDetails,
...
impl<P: RoomDataProvider> TimelineController<P> {
    pub(super) async fn new(
        ...
        Ok(Self { state, focus, room_data_provider, settings, gap_repair_projection_tx })
    }
